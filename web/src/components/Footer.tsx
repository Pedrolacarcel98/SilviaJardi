      ...
      <div className="max-w-[1200px] mx-auto px-6 py-16 flex flex-col md:flex-row justify-between items-center gap-8">
        ...
        <div className="flex flex-wrap justify-center gap-8">
          <a
            ...
            className="flex items-center gap-2 text-on-surface-variant font-body-md text-[16px] hover:text-[#25D366] transition-colors group"
            title="WhatsApp"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 text-on-surface-variant font-body-md text-[16px] hover:text-[#E1306C] transition-colors group"
            title="Instagram"
          >
            <svg viewBox="0 0 24 24" className="w-6 h-6 fill-current group-hover:scale-110 transition-transform">
            ...
            <span className="hidden md:inline">@silviajardialabau</span>
          </a>
          <a
            href="tel:+34658271773"
            className="flex items-center gap-2 text-on-surface-variant font-body-md text-[16px] hover:text-primary transition-colors group"
            title="Llamar"
          >
            <span className="material-symbols-outlined text-[24px] group-hover:scale-110 transition-transform">
              call
            </span>
            <span className="hidden md:inline">658 27 17 73</span>
          </a>
        </div>
